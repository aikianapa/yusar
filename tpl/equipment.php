...
<body class="loading body-equipment cont-color-w" >
  ...
  <section class="thermal-imager container">

    <div class="double-card disinfection">
      <div class="card card-1" data-aos="fade-up" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/thermal-imager.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
            Тепловизоры
          </h3>
      ...
      <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <div class="wrapper">
          ...
          <p class="card-text">Аппарат для аэрозольной дезинфекции</p>

        </div>
        <div class="circle">
          <span class="circle__title">742</span>
          <span class="circle__text">чего-то там</span>
          <img class="circle__img" src="tpl/assets/img/circle.svg" alt="circle">
        </div>
      </div>
    </div>

    <div class="double-card thermometers">
      <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/thermometers.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
            Термометры
          </h3>
      ...
      <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <div class="wrapper">
          ...
          <p class="card-text">Медицинская диагностика исследования молочной железы</p>
          <div class="icon-wrapper">
            <img class="icon" src="tpl/assets/img/mammography.svg" alt="icon">
  ...
  <div class="card ultrasound container" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
    <img class="background" src="tpl/assets/img/ultrasound.png" alt="background">
    <div class="wrapper">
      <h3 class="card-title">
  ...
  <section class="angiography container">

    <div class="double-card">
      <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/angiography.png" alt="background">
      ...
      <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <div class="card-wrapper">
          ...
          <p class="card-text">
            Широкие возможности систем компьютерной томографии как в повседневной практике, так&nbsp;и в научных
            исследованиях
          </p>
        </div>
  ...
  <section class="mrt container">

    <div class="double-card operation">
      <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/mrt.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
            Магнитно-резонансная томография
          </h3>
          <p class="card-text">Получения томографических медицинских изображений для исследования внутренних органов и
      ...
      <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/operation.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
    ...
    <div class="double-card kt">
      <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/kt.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
            ПЭТ/КТ
          </h3>
          <p class="card-text">Применение технологии позитронно-эмиссионной томографии в клинической практике
      ...
      <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
        <img class="background" src="tpl/assets/img/endoscopy-small.png" alt="background">
        <div class="wrapper">
          <h3 class="card-title">
            Эндоскопия
          </h3>
  ...
  <div class="radiography container double-card">
    <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
      <div class="wrapper">
        <h3 class="card-title">
    ...
    <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
      <div class="wrapper">
        ...
        <div class="icon-wrapper">
          <img class="icon" src="tpl/assets/img/laboratory.svg" alt="icon">
          <img class="icon" src="tpl/assets/img/headphones.svg" alt="icon">
          <img class="icon" src="tpl/assets/img/orbit.svg" alt="icon">
        </div>
      </div>
  ...
  <div class="bracelets container double-card">
    <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
      <img class="background" src="tpl/assets/img/bracelets.png" alt="background">
      <div class="wrapper">
        <h3 class="card-title">
          Медицинские смарт-браслет
        </h3>
    ...
    <div class="card card-2" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
      <img class="background" src="tpl/assets/img/colposcope.png" alt="background">
      <div class="wrapper">
        <h3 class="card-title">
          Кольпоскоп
        </h3>
