...
$(document).ready(function () {
  ...
  var technicalSlider = new Swiper(".technical-swiper", {
    slidesPerView: 3,
    loop: true,
    direction: "vertical",
    autoplay: {
  ...
  var integrationSlider = new Swiper(".integration-swiper", {
    slidesPerView: 3,
    loop: true,
    direction: "vertical",
    autoplay: {
  ...
  var productsSlider = new Swiper(".products__swiper-container", {
    // slidesPerView: 4,
    loopedSlides: 16,
    loop: true,
    navigation: {
