    ...
    <div class="body-mis__container">
                ...
                <div class="to-fix">
                    <div class="stage">
                        <div class="mis-top scene scene-1">
                            <h3 class="title">СИСТЕМЫ ПОДДЕРЖКИ ПРИНЯТИЯ РЕШЕНИЯ</h3>
        ...
        <section class="mis-menu-wrapper">
            <div class="mis-nav mis-container">
                <ul class="mis-menu">
                    <a href="#purpose">
                        <li class="mis-menu__item" id='item-1'>
                            Цель
                        </li>
                    </a>
                    <a href="#descriprion">
            ...
            <div class="double-card">
                <div class="card card-1" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'>
                    ...
                    <div class="wrapper">
                        ...
                        <p class="card-text">
                            Медицинская информационная система (далее - Система или МИС) предназначена для автоматизации
                            основных
                            процессов
                            деятельности лечебно-профилактических учреждений (ЛПУ): ведение электронных медицинских
                            карт,
                            сбор и
                            хранение
                            данных
                            лабораторных анализов и диагностическиз обследований, учет лекарственных препаратов,
                            формирование
                            финансововй
                            и
                ...
                <div class="card card-2 y-10" data-aos="fade-up" data-aos-duration="1700" data-aos-offset='200'
                    ...
                    <div class="wrapper">
                        ...
                        <p class="card-text">
                            Несобственно-прямая речь, по определению приводит экзистенциальный авторитаризм. Как
                            отмечает
                            А.А.Потебня,
                            комбинаторное
                            приращение взаимно. Катахреза обретает системный феномен толпы.
                        </p>
                        <br>
                        ...
                        <br>
                        <p class="card-text"> — &nbsp; Обеспечивать стабильное информационное взаимодействие
                            между&nbsp;абонентами.
                        </p>
                        <br>
                        <p class="card-text"> — &nbsp; Обеспечивать стабильное информационное взаимодействие.
            ...
            <div class="reviews__swiper-container swiper-container">
                ...
                <div class="swiper-wrapper reviews__wrapper">
                    ...
                    <div class="reviews__card swiper-slide y-10">
                        <p class="reviews__text">Как отмечает А.А.Потебня, комбинаторное приращение взаимно. Катахреза
                            обретает
                            системный феномен толпы.</p>

                        <div class="reviews__card-bottom">
                            <p class="reviews__name">А.А.Потебня</p>
                            <p class="reviews__position">Заведующий СНТ № 157, к.м.н.</p>
                        </div>
                    </div>
                    ...
                    <div class="reviews__card swiper-slide y-10">
                        ...
                        <div class="reviews__card-bottom">
                            <p class="reviews__name">Б.Ж.Потебня</p>
                            <p class="reviews__position">Заведующий СНТ № 157, к.м.н.</p>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper products__wrapper">
                    ...
                    <a href="/ris" class="card products__card-1 swiper-slide y-10">
                        <div class="card-wrapper">
                            ...
                            <p class="card-text">
                                Как отмечает А.А.Потебня, комбинаторное приращение взаимно. Катахреза обретает системный
                                феномен толпы.
                            </p>
                        </div>
                        <img class="link-icon" src="tpl/assets/img/more.svg" alt="icon">
