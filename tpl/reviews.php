...
<div class="container pt-3r pb-3r reviews">
  ...
  >
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Медицина+1" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Медицина+2" alt="">
    </div>
    <div>
  ...
  >
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Управление+1" alt="">
    </div>
    <div>
  ...
  >
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+1" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+2" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+3" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+4" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+5" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+6" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+7" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+8" alt="">
    </div>
    <div>
      <img src="https://via.placeholder.com/320x400.png?text=Интеграция+9" alt="">
    </div>
  </div>
</div>
