...
<div class="container mb-3r mt-3r block-account" id="Profile">
    <ul class="nav nav-stacked">
        <li class="nav-item">
            <a href="#TabProfile" data-toggle="tab" class="nav-link active">Профиль</a>
        </li>
        <li class="nav-item">
            <a href="#TabArticles" data-toggle="tab" class="nav-link">Статьи</a>
        </li>
        <li class="nav-item">
            <a href="#TabVideo" data-toggle="tab" class="nav-link">Видео</a>
        </li>
        <li class="nav-item">
            <a href="#TabDocs" data-toggle="tab" class="nav-link">Документы</a>
        </li>
    </ul>
