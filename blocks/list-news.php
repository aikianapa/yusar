                    ...
                    <div class="col-lg-12">
                        <div style="width: 100%; box-sizing: border-box; display: flex; flex-wrap: wrap;" class="sorting-block">
                            ...
                            <div class="item-inner year">
                                <span>Год</span>
                                <wb-var year='{{date("Y")}}' />
                                <wb-var first wb-api="/api/v2/list/news?@sort=date&@return=date&@limit=1" />
                                <wb-var first='{{explode(" ","{{_var.first.0.date}}")}}' />
                                <wb-var count='{{ {{_var.year}} - {{_var.first.2}}  }}' />
                                <div class="custom-select-wrapper">
                                    <div class="select-block">
                                        Все
                                    </div>
                                        <div class="select-block-options">
                                            ...
                                            <wb-foreach wb="count={{_var.count}}&tpl=false">
