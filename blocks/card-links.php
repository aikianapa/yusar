<edit header="Катрочки с сылками"><div>
        <wb-include wb-src="/engine/modules/yonger/common/blocks/common.inc.php"></wb-include>
    </div>
<div class="row">
  <label class="col-6 col-sm-3 form-control-label mb-1">
...
<wb-multiinput name="cards">
        <div class="col-sm-4 pr-3">
            <wb-module wb="module=filepicker&mode=single&width=300&height=150" name="image" wb-path="/uploads/blocks/card-links" wb-ext="webp,jpg,png,jpeg,svg"></wb-module>
        </div>
        ...
        <div class="col-sm-8">
            <div class="form-group row">
                ...
                <div class="col-sm-9 mb-1">
                    <input type="text" name="title" class="form-control tx-bold" placeholder="Заголовок" wb-module="langinp">
                </div>
                <label class="col-sm-3 form-control-label mb-1">Ссылка</label>
                <div class="col-sm-9 mb-1">
                    <input type="text" name="link" class="form-control" placeholder="Ссылка кнопки" wb="module=yonger&mode=pageselect">
                </div>

            </div>

        </div>
    </wb-multiinput></edit><view><div class="pt-3r s-indent-bottom widget-service widget-service--service">
                        ...
                        <a href="{{link}}">
                            <div class="card card--second">
                                <div class="image__container">
                                    <img class="card-img-top" data-src="/thumbc/{{_var.width}}x{{_var.height}}/src{{image.0.img}}" alt="{{title.{{_sess.lang}}}}" wb-if="'{{image.0.img}}'>''">
                                    <img class="card-img-top" data-src="/thumbc/{{_var.width}}x{{_var.height}}/src/assets/img/widget-holder.jpg" alt="{{title.{{_sess.lang}}}}" wb-if="'{{image.0.img}}'==''">
                                </div>
                                <div class="card-body">
