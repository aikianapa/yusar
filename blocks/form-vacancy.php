...
<view>
    <div class="footer container contacts-feedback pt-3r">
        ...
        <form method="POST" class="footer__form form">
            <div class="footer__top-wrapper">
                <div class="footer__input-group footer__input">
                ...
                <div class="footer__input-group footer__input">
                    <input type="text" class="input footer__input" placeholder="{{_lang.vacancy}}*" name="vacancy"
                        required minlength="2">
                </div>
            </div>
    ...
    <wb-lang>
        ...
        vacancy = Vacancy
        [ru]
        feedback = "Оставьте свою заявку здесь"
